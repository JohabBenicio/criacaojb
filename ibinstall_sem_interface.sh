HOST=`hostname`
export HOST=$(echo $HOST | cut -f1 -d".")

mkdir -p /u01/app/oraInventory

rm -f /home/oracle/patchset.rsp

vi /home/oracle/patchset.rsp
...
#------------------------------------------------------------------------------
MYORACLESUPPORT_USERNAME=dba@teor.inf.br
...
#------------------------------------------------------------------------------
MYORACLESUPPORT_PASSWORD=welcome
...
cat /home/oracle/patchset.rsp | grep -i ORACLE_HOME

find /home/oracle/patchset.rsp -exec sed -i 's/$ORACLE_HOME/'$ORACLE_HOME'/g' {} \;





/backup/database/runInstaller -silent -responseFile /home/oracle/patchset.rsp
