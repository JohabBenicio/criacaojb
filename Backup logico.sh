...
# ------ -------- --------- ------ ------- -----------------------------------------------------------------------------------------------------+
  00     22       *         *      *       /u01/app/oracle/admin/msafprd/scripts/backup/logico/expdp_full.sh $ORACLE_SID 1>/dev/null 2>/dev/null
...
expdp \'/ as sysdba\'  full=Y directory=$EXPDP dumpfile=$BKPDMP logfile=$BKPLOG filesize=4G
